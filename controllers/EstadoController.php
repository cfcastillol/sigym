...
class EstadoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if($model->save()){
                Yii::$app->session->setFlash('success', 'Estado guardado exitosamente');
            }else{
                Yii::$app->session->setFlash('danger', 'No se pudo guardar el estado');
            }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if($model->save()){
                ...
                Yii::$app->session->setFlash('danger', 'No se pudo actualizar el estado');
            }
            return $this->redirect(['index']);
        } else {
